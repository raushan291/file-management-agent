...
A simple **Agentic AI application** that can manage files and directories using natural language. This version (v3) uses Google Agent Development Kit (ADK) with the Model Context Protocol (MCP) for tool integration.
